...
from work_flow.utils.yolov6_face import letterbox, xywh2xyxy, warp_im, coord5point1, coord5point2, imgSize1, imgSize2, numpy_nms, rescale_box_and_landmark

class YOLOv6Face:

    def __init__(self, model_path, device='gpu', scale='112x112', conf_thres=0.25, iou_thres=0.45, agnostic=False, input_shape=(320,320)) -> None:
        self.scale = scale
